...
CREATE INDEX idx_ledger_contacts_user_active ON public.ledger_contacts(user_id, is_active);
...
-- ---------------------------------------------------------------------------
-- 13. ledger_transactions (money given / received per contact)
-- ---------------------------------------------------------------------------
...
CREATE INDEX idx_ledger_transactions_contact_id ON public.ledger_transactions(contact_id);
...
-- ---------------------------------------------------------------------------
-- ledger_contacts — per-operation policies
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- ledger_transactions — policies via join to ledger_contacts
-- ---------------------------------------------------------------------------
